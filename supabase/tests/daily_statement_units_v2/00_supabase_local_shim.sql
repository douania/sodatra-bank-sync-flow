-- ============================================================================
-- 0H — SHIM SUPABASE LOCAL (TESTS UNIQUEMENT — NE JAMAIS APPLIQUER EN PROD)
-- ============================================================================
-- Émule sur un Postgres jetable les objets plateforme dont dépend la
-- migration candidate v2 : rôles anon/authenticated/service_role, default
...
-- Lot 2B 20260430150428). Copie adaptée du shim v1
-- (supabase/tests/structured_csv_import_v1/00_supabase_local_shim.sql).
-- ============================================================================
