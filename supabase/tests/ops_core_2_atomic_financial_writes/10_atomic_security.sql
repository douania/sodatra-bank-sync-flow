...
DO $$ BEGIN
  BEGIN
    PERFORM public.save_bank_report_atomic_v1(
      ...
      '[{"date_echeance":"2026-08-09","date_retour":null,"client_code":null,"description":null,"montant":10}]'
    );
...
DO $$ BEGIN
  BEGIN
    PERFORM public.save_fund_position_atomic_v1(
      ...
      '[{"hold_date":"2026-08-11","cheque_number":null,"client_bank":null,"client_name":null,"facture_reference":null,"amount":10,"deposit_date":null,"days_remaining":null}]'
    );
